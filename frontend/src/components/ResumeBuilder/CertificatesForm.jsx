  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        {data.map((cert, index) => (
          <div key={cert.uiId || cert.id || index} className="p-6 border rounded-xl relative group bg-gray-50/50">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-1">
                <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Certificate Name</label>
                <input
                  type="text"
              ...
              <div className="col-span-1">
                <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Issuing Organization</label>
                <input
                  type="text"
                  className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none bg-white"
              ...
              <div className="col-span-1">
                <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Credential ID</label>
                <input
                  type="text"
                  className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none bg-white"
